 ...
 * Time: 1:16 PM
 */
public class ImportResponseAllDepts {
    public static void main(String[] args) {
        new ImportResponseAllDepts();
    }
    ...
    String ProcessNam = "_Response";

    public ImportResponseAllDepts() {
...
//        Состовляем имя процесса
            String ProcessName = dataSource.get(0).getProcessName() + "_Response_"+dataSource.get(0).getBeanId();
