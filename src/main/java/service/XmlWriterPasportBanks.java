 ...
 * Time: 12:58 AM
 */
public class XmlWriterPasportBanks {
    ...
    public XmlWriterPasportBanks(String outputDirectoryBanks, String filenameBanks) throws FlowException, TransformerConfigurationException, SAXException, FileNotFoundException {
     ...
     * @param outBanks 1
     */
    public XmlWriterPasportBanks(OutputStream outBanks) throws FlowException, TransformerConfigurationException, SAXException, FileNotFoundException {
...
//            hd.characters(new char[]{13}, 0, 1);
     ...
     */
    public void writeRequestPasportBanks(RequestBanks z) throws FlowException {
        if (z == null) return;
